"""
MeetMagus — Email Notifications via SendGrid
...
Requires:
    ...
    SENDGRID_FROM_EMAIL in .env  (e.g. intelligence@meetmagus.ai)
    SENDGRID_FROM_NAME in .env   (e.g. MeetMagus Intelligence)
"""
...
FROM_EMAIL         = os.environ.get("SENDGRID_FROM_EMAIL", "intelligence@meetmagus.ai")
FROM_NAME          = os.environ.get("SENDGRID_FROM_NAME", "MeetMagus Intelligence")
...
<table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;border:1px solid #E5E7EB">
    ...
    <td style="background:#0F3D82;padding:16px 28px">
      <table width="100%" cellpadding="0" cellspacing="0"><tr>
        <td>
          ...
          <span style="color:rgba(255,255,255,0.92);font-size:12px;font-weight:700;letter-spacing:0.07em;text-transform:uppercase;vertical-align:middle">MeetMagus Intelligence</span>
        </td>
        <td align="right">
  ...
  <tr>
    <td style="padding:24px 28px">
      ...
      <p style="font-size:12px;color:#6B7280;margin:0 0 16px;font-family:Arial,sans-serif">Click a reply below &mdash; MeetMagus will follow up based on your answer.</p>
  ...
  <tr>
    <td style="background:#F9FAFB;border-top:1px solid #F3F4F6;padding:14px 28px">
      <p style="font-size:11px;color:#6B7280;font-weight:700;margin:0 0 3px;font-family:Arial,sans-serif">MeetMagus Intelligence &middot; context saved automatically</p>
...
def send_alert_email(
    ...
    """
    Send a MeetMagus intelligence alert email via SendGrid.
...
if __name__ == "__main__":
    ...
    if dry:
        ...
        # Save preview HTML
        preview_path = Path(__file__).parent.parent.parent / "meetmagus_email_preview.html"
