# MeetMagus — Project Handoff Briefing v3
## What It Is
MeetMagus is an AI-powered intelligence platform that keeps relationship-driven professionals permanently attuned to the companies and people they care about — without them having to do any work to stay that way. Starting with investment bankers and M&A advisors. Expanding to healthcare bankers, consultants, staffing firms, and any professional whose value is relationship-based.

**The product objective is not bakeoff preparation.** It is continuous attunement. The banker is always in the same frequency and wavelength as their clients and prospects. When any moment arrives — a call, a referral, a bakeoff, a chance meeting — they are already the most informed person in the room. That state is built over months of continuous signal collection, not 72 hours of manual research. A bakeoff win is one downstream outcome of this, not the product goal.
...
Mid-market advisory firms, boutiques, large banks. Signals that matter: EDGAR filings, executive moves, competitive M&A activity, financial signals, hiring patterns indicating exit preparation.
...
| Item | Detail |
|---|---|
| **Live URL** | `https://meetmagus-production-f0ce.up.railway.app` |
| **API Docs** | `https://meetmagus-production-f0ce.up.railway.app/docs` |
| **GitHub** | `honeybadgerrrai-netizen/meetmagus` (main branch, auto-deploy on push) |
...
- Tier 2 (75K ecosystem companies): ~11,000 signals/day
...
| LLM processing (DeepInfra, Qwen mix) | ~$15 |
| Storage (Postgres + vectors) | $50-500 |
| Infrastructure (compute) | $500-2,000 |
| **Total** | **$15,000-20,000/month** |
### Unit Economics
At $2,000/month per banker seat with 50 bankers across 5 firms = $100K/month revenue against $20K cost = 80% gross margin. Cost scales sub-linearly — global intelligence layer is collected once, served to many tenants.
---
